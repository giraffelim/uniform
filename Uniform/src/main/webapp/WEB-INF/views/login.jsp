...
<body>
	<form method="post" action="/login" id="login_form">
		...
		<input type="button" value="ID/PW 찾기" id="selectUP"> <input
			type="submit" value="로그인" id="logins"> <input type="hidden"
			name="${_csrf.parameterName }" value="${_csrf.token }"> <a
			href="${naver_url }"><img width="270"
			src="/resources/images/naver-login.png" alt="Naver Login"></a> <a
			href="${google_url }"><img style="margin-top: 5px;" width="270"
			...
			<div class="modal-body">
				<form method="post" action="/uniform/find_id" id="id_form">
					<input type="hidden" name="${_csrf.parameterName }"
						value="${_csrf.token }" /> <label>Name</label> <input type="text"
						class="find" id="id_userName" name="name"
