								...
								<div class="container-fluid">
									<div class="profile-container">
										...
										<div class="row profile-Row">
											<div
												class="col-sm-4  d-flex justify-content-center align-items-center profile-icon"></div>
									...
									<div class="profile-container">
										...
										<div class="profile-btn-div2">
											<button type="button" class="btn btn-default"
												data-toggle="modal" data-target="#cardModify">수정</button>
											<button type="button" class="btn btn-default">조회</button>
										</div>


										<!-- Modal -->
										<div id="cardModify" class="modal fade sinchung_modal"
											role="dialog">
											<div class="modal-dialog">
												...
												<div class="modal-content">
													<div class="modal-header">
														<h4 class="modal-title">결제 수단 수정</h4>
											...
											<div class="modal-body left-context">
												<div class="row">
													...
													<div class="col-md-6 img_div">
														<div class="author-image" id="sinchungThumbnail">
														
														</div>
													</div>
													<div class="col-md-12 apply_info iSinchungStr"></div>
												</div>
											</div>
										</div>
									</div>
