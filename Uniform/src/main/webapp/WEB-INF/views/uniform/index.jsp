				...
				<div class="col-md-10">
					<div class="row d-md-flex align-items-start">
						...
						<div
							...
							<div class="block-18">
								<div class="text">
									<strong class="number" data-number="351">0</strong> <span>명이 당신을 찾고 있어요!</span>
								</div>
							</div>
						</div>
						<div
							...
							<div class="block-18">
								<div class="text">
									<strong class="number" data-number="564">0</strong> <span>¸명이 기다리고 있어요!</span>
								</div>
							</div>
						</div>
			...
			<div class="row justify-content-end">
				<div class="col-md-10">
					<div id="home" class="video-hero js-fullheight"
						style="height: 700px; background-image: url(/resources/images/bg_2.jpg); background-size: cover; background-position: center center;">
						<a class="player"
							data-property="{videoURL:'https://www.youtube.com/watch?v=sQjdUgf23G8',containment:'#home', showControls:false, autoPlay:true, loop:true, mute:true, startAt:0, opacity:1, quality:'default'}"></a>
						<div class="container">
							<div
			...
			<div class="row">
				<div class="col-md-6 project">
					<div class="img js-fullheight"
						style="background-image: url(/resources/images/work-4.jpg);">
						<div class="text text-2 text-center">
							<h2>
								<a href="#">People wanted</a>
							</h2>
						</div>
					</div>
				</div>
				...
				<div class="col-md-12 text-center ftco-animate">
					<h2>
						<a href="#" class="btn-custom-2">View All Projects</a>
					</h2>
				</div>
			</div>
		</div>
