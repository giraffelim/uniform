					...
					<div class="row">
						...
						<div style="border: 1px solid black;"
							...
							<div>
								...
								<div>
									<div id="inoResultMap"
										style='box-sizing: border-box; width: 100%; height: 500px; overflow: hidden;'>
									</div>
								</div>
						...
						<div id="boxReservationI" style="border: 1px solid black"
							...
							<div id="reservationTap" class="reservation1">
								...
								<!-- 1set-->
								<div>
									<form action="/uniform/insertShinChung" method="post"
										id="timeSelect">
										<input type="hidden" name="ino" value="${workplaceVO.ino }">
										<input type="hidden" name="${_csrf.parameterName }"
											value="${_csrf.token }"> <input type="hidden"
											name="mno" value="${pinfo.member.mno }">
										<!-- 1set-->
										<div id="iBtn">
											<input type="submit" class="btn btn-danger" value="예약하기">
											<input type="button" class="btn btn-danger" value="찜 하 기"
												onclick="clearSelect();">
										</div>
									</form>
									<!-- selectBox-->
									<div id="inoClone">
										<select name="reservation"
											class="browser-default custom-select selectBox res"
											id="select1">
											<option data-res="25" value="">사용시간 선택</option>
											<option data-res="00:00~02:00" value="00:00~02:00">00
												: 00 ~ 02 : 00</option>
											<option data-res="02:00~04:00" value="02:00~04:00">02
												: 00 ~ 04 : 00</option>
											<option data-res="04:00~06:00" value="04:00~06:00">04
												: 00 ~ 06 : 00</option>
											<option data-res="06:00~08:00" value="06:00~08:00">06
												: 00 ~ 08 : 00</option>
											<option data-res="08:00~10:00" value="08:00~10:00">08
												: 00 ~ 10 : 00</option>
											<option data-res="10:00~12:00" value="10:00~12:00">10
												: 00 ~ 12 : 00</option>
											<option data-res="12:00~14:00" value="12:00~14:00">12
												: 00 ~ 14 : 00</option>
											<option data-res="14:00~16:00" value="14:00~16:00">14
												: 00 ~ 16 : 00</option>
											<option data-res="16:00~18:00" value="16:00~18:00">16
												: 00 ~ 18 : 00</option>
											<option data-res="18:00~20:00" value="18:00~20:00">18
												: 00 ~ 20 : 00</option>
											<option data-res="20:00~22:00" value="20:00~22:00">20
												: 00 ~ 22 : 00</option>
											<option data-res="22:00~24:00" value="22:00~24:00">22
												: 00 ~ 24 : 00</option>
										</select>
									</div>
									<!-- //selectBox-->
									<div id="addSelect">
										<select name="reservation"
											...
											<option data-res="22:00~24:00" value="22:00~24:00">22
												: 00 ~ 24 : 00</option>
										</select> <select name="reservation"
											class="browser-default custom-select selectBox res"
											id="select3">
											<option data-res="25" value="">사용시간 선택</option>
											<option data-res="00:00~02:00" value="00:00~02:00">00
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
							...
							<div class="row">
								<div class="col-xs-11 col-sm-11 col-md-11 col-lg-11">
									<b class="hugi">후기</b> <b class='hugiStar'>총별점</b>
								</div>
					...
					<div id="inofooter">
						<div id="inofooterBtn" class="text-center"
							...
							<button style="margin-left: 5px; margin-right: 5px;"
								class="btn btn-danger btn-sm float-right">찜 하 기</button>
