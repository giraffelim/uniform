		...
		<div class="row mb-5">
			<div class="col-md">
				<div class="ftco-footer-widget mb-4 ml-md-4">
					...
					<ul class="list-unstyled photo">
						<li><a href="#" class="img"
							style="background-image: url(/resources/images/work-1.jpg);"></a></li>
						<li><a href="#" class="img"
							style="background-image: url(/resources/images/work-2.jpg);"></a></li>
						<li><a href="#" class="img"
							style="background-image: url(/resources/images/work-3.jpg);"></a></li>
			...
			<div class="col-md">
				<div class="ftco-footer-widget mb-4">
					...
					<ul class="list-unstyled categories">
						<li><a href="#">July 2019 <span class="pr-lg-5">(20)</span></a></li>
						<li><a href="#">June 2019 <span class="pr-lg-5">(30)</span></a></li>
					...
					<div class="block-23 mb-3">
						<ul>
							<li><span class="icon icon-map-marker"></span><span
								class="text">영등포구 선유로</span></li>
							<li><a href="#"><span class="icon icon-phone"></span><span
									class="text">+82 1234 5678</span></a></li>
							<li><a href="#"><span class="icon icon-envelope"></span><span
									class="text">uniform@gmail.com</span></a></li>
						</ul>
					</div>
				</div>
			</div>
